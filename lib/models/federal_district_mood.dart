...
/// Модель федерального округа с данными о настроении
class FederalDistrictMood {
  final String id;
  final String name;
  final double averageMood; // Средний балл настроения (1-5)
  final int totalCheckIns; // Количество чек-инов
  final int population; // Население округа
  ...
  /// Создать из JSON
  factory FederalDistrictMood.fromJson(Map<String, dynamic> json) {
